package com.bantutani.application.data.network.paging
...
class PlantsSearchSource(queryText: String) : PagingSource<Int, GetAllPlantsResponseItem>()  {
    private  val searchdata: String = queryText
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, GetAllPlantsResponseItem> {
        return try {
            val page = params.key ?: PlantsSearchSource.INITIAL_PAGE_INDEX
            val responseData = APIConfig.getApiService().plantsSearch(searchdata, page, params.loadSize)
