...
class UsernameTextField : AppCompatEditText, View.OnTouchListener {
    ...
    private fun init() {
        ...
        UsernameImage = ContextCompat.getDrawable(context, R.drawable.ic_username) as Drawable
        ...
        addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence, start: Int, before: Int, count: Int) {
                ...
                if (s.length > 8) {
                    error = resources.getString(R.string.username_error_too_long)
                }
    ...
    private fun setButtonDrawables(
        startOfTheText: Drawable? = UsernameImage,
